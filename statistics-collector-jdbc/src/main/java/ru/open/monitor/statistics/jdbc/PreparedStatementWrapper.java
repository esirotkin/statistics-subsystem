...
public class PreparedStatementWrapper extends StatementWrapper implements PreparedStatement {
    ...
    PreparedStatementWrapper(final PreparedStatement preparedStatement, final String sql, final StatisticsCollector statisticsCollector) {
        super(preparedStatement, statisticsCollector);
    ...
    protected String getStatementName() {
        return prepareStatementName(sql);
    }
    ...
    public long executeLargeUpdate() throws SQLException {
        resetResultSetNumber();
        long startNanos = System.nanoTime();
        long updateCount = preparedStatement.executeLargeUpdate();
        long stopNanos = System.nanoTime();
        statisticsCollector.statementExecuted(getStatementName(), stopNanos - startNanos);
        return updateCount;
    }
