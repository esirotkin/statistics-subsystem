...
public class CallableStatementWrapper extends PreparedStatementWrapper implements CallableStatement {
    ...
    CallableStatementWrapper(final CallableStatement callableStatement, final String sql, final StatisticsCollector statisticsCollector) {
        super(callableStatement, sql, statisticsCollector);
